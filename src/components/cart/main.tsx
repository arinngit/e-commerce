...
import { ChevronRight, Minus, Plus, Trash2, Tag, ShoppingBag } from "lucide-react";
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 bg-white min-h-screen">
      ...
      {items.length === 0 ? (
        <div className="text-center py-8 sm:py-12">
          ...
          <p className="text-base sm:text-lg text-gray-600 mb-3 sm:mb-4 font-satoshi font-bold">Your cart is empty</p>
          <Link 
            href="/shop" 
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-xs sm:text-sm text-gray-600 mb-1">
                      <span className="font-satoshi font-bold">Size: </span>
                      <span className="text-black font-satoshi font-bold">{item.size}</span>
                    </div>

                    <div className="text-xs sm:text-sm text-gray-600 mb-3 sm:mb-4">
                      <span className="font-satoshi font-bold">Color: </span>
                      <span className="text-black font-satoshi font-bold">{item.color}</span>
                    </div>
            ...
            <div className="border border-gray-200 rounded-lg p-4 sm:p-6 lg:sticky lg:top-6 shadow-sm">
              ...
              <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
                <div className="flex justify-between text-sm sm:text-base">
                  <span className="text-gray-600 font-satoshi font-bold">Subtotal</span>
                  <span className="font-satoshi font-bold">${subtotal.toFixed(2)}</span>
                </div>

                <div className="flex justify-between text-sm sm:text-base">
                  <span className="text-gray-600 font-satoshi font-bold">Delivery Fee</span>
                  <span className="font-satoshi font-bold">${deliveryFee.toFixed(2)}</span>
                </div>
              ...
              <div className="mb-4 sm:mb-6">
                <label htmlFor="promo-code" className="block text-xs sm:text-sm font-satoshi font-bold text-gray-700 mb-1 sm:mb-2">
                  Promo Code
                </label>
